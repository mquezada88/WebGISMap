...
public class WalkingDirectionActivity extends AppCompatActivity implements OnMapReadyCallback, View.OnClickListener, DirectionCallback, LatLngCallback {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        autocompleteViewOrigin.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                Toast.makeText(WalkingDirectionActivity.this, description, Toast.LENGTH_SHORT).show();
            }
        });
